...
Summary: Alternate names associated with a client.
...
| NameTypeKey | Edm.Int32 | false |
| NameType | Edm.String | true |
| Name | Edm.String | true |

## API Usage

- GET /api/clientengine/Name10

### Filter example
`GET /api/clientengine/Name10?$filter=ClientKey eq 123`
