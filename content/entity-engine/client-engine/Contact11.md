...
Summary: Contact records with email and activity windows.
...
| IsCreditControl | Edm.Boolean | true |
| IsBilling | Edm.Boolean | true |

## API Usage

- GET /api/clientengine/Contact11

### Filter example
`GET /api/clientengine/Contact11?$filter=IsBilling eq true`
