...
Summary: Communication preferences and contact channels.
...
| ContactEmail | Edm.String | true |
| IsPrimary | Edm.Boolean | true |
| CommunicationTypeKey | Edm.Int32 | false |
| CommunicationType | Edm.String | true |
...
### Filter example
`GET /api/clientengine/Communication11?$filter=ClientKey eq 123 and IsPrimary eq true`
