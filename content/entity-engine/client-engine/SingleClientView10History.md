# SingleClientView10History

Summary: Historical snapshot rows for single client view.

## Fields

| Name | Type | Nullable |
|------|------|----------|
| C_TableId | Edm.Int32 | false |
...
| C_ChangeDate | Edm.DateTimeOffset | true |
| C_Key_A_ClientKey | Edm.String | true |
| C_KeyRowId | Edm.Int32 | false |
| C_RowHashValue | Edm.Binary | true |
| C_Operation | Edm.Int32 | false |

## API Usage

- GET /api/clientengine/SingleClientView10History

### Filter example
`GET /api/clientengine/SingleClientView10History?$filter=C_EntityKey eq 123`
