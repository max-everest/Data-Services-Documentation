# SingleClientOpenView11

Summary: Lightweight single-client open view (v11) with flags.
...
- GET /api/clientengine/SingleClientOpenView11

### Filter example
`GET /api/clientengine/SingleClientOpenView11?$filter=IsProspective eq true`
